...
/// Plugin skills are also embedded so they can be copied into generated projects.
static EMBEDDED_PLUGINS: Dir = include_dir!("$CARGO_MANIFEST_DIR/../../plugins");
...
fn run() -> Result<(), Box<dyn std::error::Error>> {
    ...
    copy_skills(&EMBEDDED_PLUGINS, &dest)?;
